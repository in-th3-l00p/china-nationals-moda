        ...
        <div class="right-content grow">
            ...
            <main class="p-8 pt-5">
                ...
                <h1 class="flex items-center">
                    <div class="flex h-10 w-10 items-center justify-center rounded-full bg-green-100 mr-6"><svg
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" aria-hidden="true" class="h-6 w-6 text-green-600">
                ...
                <div class="content">
                    ...
                    <div>
                        <p class="text-gray-500 text-sm">
                            The new password is: <span class="italic text-red-500 font-semibold">{ NEW PASSWORD }</span>
                            ,refresh this page will be redirect to the list page automatically.
                        </p>

                        <!-- Form Footer -->
                        <div class="form-footer">
                            <a href="staff-management/courier-list.html" class="link-btn py-2 px-2 text-sm">Back to list</a>
                        </div>
