    ...
    <div class="flex h-full">
        ...
        <div class="left-sidebar">
            ...
            <nav class="text-indigo-200 text-sm font-medium stroke-indigo-200">
                ...
                <div class="menu-item">
                    <a href="index.html">
                        <svg class="w-6" fill="currentColor" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div class="right-content grow">
            ...
            <header class="flex justify-between shadow-sm px-8 py-4">
                ...
                <div class="flex items-end content-header-right text-sm">
                    ...
                    <a href="login.html" class="logout-func">Logout</a>
                </div>
            </header>
            ...
            <main class="p-8 pt-5">
                ...
                <h1 class="flex justify-between items-center">
                    <span>Trucker List</span>
                    <a class="link-btn btn-sm" href="staff-management/trucker-create.html">Add trucker</a>
                </h1>
                <div class="content">
                    <div class="table-header">
                        <div class="filter mt-2">
                            <div class="filter-label">Filter by route: </div>
                            <div class="filter-terms">
                                <a href="" class="link-badge badge link-badge-active mr-2">All</a>
                                <a href="" class="link-badge badge mr-2">Route 1</a>
                                <a href="" class="link-badge badge mr-2">Route 2</a>
                            </div>
                        </div>
                    </div>
                    <!-- Table Data -->
                    <table class="mt-2 data-table">
                        <thead class="bg-gray-0">
                            <tr>    
                                <th class="w-3">ID</th>
                                <th>Name</th>
                                <th class="w-60">Plate Number</th>
                                <th class="w-60">Email</th>
                                <th class="w-32">Route</th>
                                <th class="w-36">Operation</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>{ Route }</td>
                                <td>
                                    <a href="staff-management/reset-password.html" class="link-danger">Reset Password</a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Rebecca Green</td>
                                <td>ABC1000</td>
                                <td>andrew.foster@example.com</td>
                                <td>Route 1</td>
                                <td>
                                    <a href="staff-management/reset-password.html" class="link-danger">Reset Password</a>
                                </td>
                    ...
                    <div class="table-footer">
                        ...
                        <nav class="pagination-function">
                            ...
                            <a href="#" class="page-btn cur-pg-btn">1</a>
