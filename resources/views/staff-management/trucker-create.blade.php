        ...
        <div class="right-content grow">
            ...
            <main class="p-8 pt-5">
                ...
                <h1 class="flex justify-between items-center">
                    <span>Create New Trucker</span>
                </h1>

                <div class="content">

                    <form action="staff-management/trucker-list.html">
                        ...
                        <div class="form-footer">
                            ...
                            <a href="staff-management/trucker-list.html" class="link-danger py-2 px-2 text-sm">Cancel</a>
                        </div>
