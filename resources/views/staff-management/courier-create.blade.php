        ...
        <div class="right-content grow">
            ...
            <main class="p-8 pt-5">
                ...
                <h1 class="flex justify-between items-center">
                    <span>Create New Courier</span>
                </h1>

                <div class="content">

                    <form action="staff-management/courier-list.html">

                        <div class="flex">
                            <div class="form-control mr-6">
                                <label class="form-label">First Name</label>
                                <input type="text" name="firstname" class="w-44">
                            </div>

                            <div class="form-control">
                                <label class="form-label">Last Name</label>
                                <input type="text" name="lastname" class="w-44">
                            </div>
                        </div>

                        <div class="form-control mt-5">
                            <label class="form-label">Phone Number</label>
                            <input type="text" name="phone" class="w-94">
                        </div>

                        <div class="form-control mt-5">
                            <label class="form-label">Email</label>
                            <input type="text" name="email" class="w-94 form-error" >
                            <p class="form-error-message">{ Error message }</p>
                        </div>

                        <div class="form-control mt-5">
                            <label class="form-label">Password</label>
                            <input type="password" name="password" class="w-94">
                        </div>

                        <div class="form-control mt-5">
                            <label class="form-label">Repeat Password</label>
                            <input type="password" name="repeat_password" class="w-94">
                        </div>

                        <div class="form-control mt-5">
                            <label class="form-label">Campus</label>
                            <select class="w-94" name="campus">
                                <option value="">Campus A</option>
                                <option value="">Campus B</option>
                                <option value="">Campus C</option>
                                <option value="">Campus D</option>
                                <option value="">Campus E</option>
                            </select>
                        ...
                        <div class="form-footer">
                            ...
                            <a href="staff-management/courier-list.html" class="link-danger py-2 px-2 text-sm">Cancel</a>
                        </div>
